...
- **C — Knows Astro**: Ask what they want to learn. Focus on current Astro features (Content Layer API, `ClientRouter`, server islands, sessions). Lesson 1 can be compressed if they already have a project.
...
- Node.js v22.12.0 or higher (run `node -v` to check) — Astro 6 dropped Node 18 and 20; odd-numbered versions like v23 are not supported
