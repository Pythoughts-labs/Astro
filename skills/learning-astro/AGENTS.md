...
**Version:** 1.1.0 | **Astro 6.x** | **Updated:** 2026-06-20 | **Author**: elkaix
...
| **Adaptation** | Beginner: explain web basics; framework dev: compare mental models; Astro user: focus on advanced Astro features |
...
└─ Used Astro before ──> ask goals; compress basics; emphasize current Astro features
```
...
- **NEVER** let experienced users get stuck in basics if they are clearly ready for advanced topics
